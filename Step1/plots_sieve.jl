...
function plot_sieve_totalvalidity_E(N::Int64=1024, f::Float64=0.1, G::Int64=300, E_thr::Int64=200, minE::Int64=200, maxE::Int64=400, step::Int64=10)
    ...
    savefig(p, fp*"sieve_totalvalidity_changeE_N($N)_f($f)_G($G)_E_thr($E_thr)")
end
...
function plot_sieve_totalvalidity_E_thr(N::Int64=1024, f::Float64=0.1, G::Int64=300, E::Int64=200, minE_thr::Int64=200, maxE_thr::Int64=400, step::Int64=10)
    ...
    savefig(p, fp*"sieve_totalvalidity_changeE-thr_N($N)_f($f)_G($G)_E($E)")
end
...
function plot_sieve_consistency_E(N::Int64=1024, f::Float64=0.1, E_thr::Int64=200, minE::Int64=200, maxE::Int64=400, step::Int64=10)
    ...
    savefig(p, fp*"sieve_consistency_changeE_N($N)_f($f)_E_thr($E_thr)")
end
...
function plot_sieve_sieve_consistency_E_thr(N::Int64=1024, f::Float64=0.1, E::Int64=200, minE_thr::Int64=200, maxE_thr::Int64=400, step::Int64=10)
    ...
    savefig(p, fp*"sieve_consistency_changeE-thr_N($N)_f($f)_E($E)")
end
...
function plot_sieve()
    ...
    for n in 9:12
        ...
        plot_sieve_totalvalidity_E(N=2^n, G=G, E_thr=E_thr, minE=E_thr, maxE=3*E_thr)
        plot_sieve_consistency_E(N=2^n, G=G, E_thr=E_thr, minE=E_thr, maxE=3*E_thr)
        plot_sieve_totalvalidity_E_thr(N=2^n, G=G, E=E, minE_thr=floor(Int, E/3), maxE_thr=E)
        plot_sieve_sieve_consistency_E_thr(N=2^n, E=E, minE_thr=floor(Int, E/3), maxE_thr=E)
    end
end
